module.exports = {
   ...
   * 要忽略做标签属性
   */
  ignoreTagAttr: ['id', 'class', 'style', 'src', 'href', 'width', 'height'],
  /**
  ...
  i18nMethod: '$t',
  /**
   * 如果不喜欢又臭又长的key 可以自定义国际化配置文件的key 只接受函数类型 function({key, value})
   * 默认为 false 不自定义 
   */
  setMessageKey: false,
  /**
   ...
   */
  i18nInstance: "import i18n from '@/vuei18n'",
  /**
   * 格式化文件配置
   */
  prettier: {
